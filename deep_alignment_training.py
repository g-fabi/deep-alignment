...
from models.STDAT3 import STDAT
from models.DSTformer3 import DSTformer
...
def parse_arguments():
    ...
    parser.add_argument('--framework', default='cmc', choices=["cmc", "cmc-cmkm", "cmc-cmkm-deep-alignment"])
...
def ssl_pre_training(args, modalities, experiment_cfg, ssl_cfg, dataset_cfg, model_cfgs, transform_cfgs, augmentation_cfgs, experiment_id, loggers_list, loggers_dict):
    ...
    if args.framework == 'cmc':
        ...
        temperature = ssl_cfg['kwargs'].get('temperature', 0.1)
